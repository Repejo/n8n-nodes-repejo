...
export class RepejoTrigger implements INodeType {
    description: INodeTypeDescription = {
        ...
        properties: [
            ...
            },
            {
                ...
                default: '',
                description: 'The secret key used to validate webhook signatures (HMAC-SHA256)',
            ...
            },
            {
                ...
                type: 'boolean',
                default: true,
                description: 'Whether to validate the webhook signature. Recommended for security.',
            },
        ],
    };
    ...
    async webhook(this: IWebhookFunctions): Promise<IWebhookResponseData> {
        ...
        if (validateSignature && webhookSecret) {
            ...
            if (!signature) {
                throw new NodeOperationError(this.getNode(), 'Missing Repejo-Signature header');
            }
            ...
            try {
                ...
                // If signature validation fails, we still allow the webhook through but log a warning
                console.warn('Repejo webhook signature validation failed:', error);
            }
        }
        ...
        if (now.getTime() - sentAt.getTime() > maxAge) {
            throw new NodeOperationError(this.getNode(), 'Webhook is too old (replay attack protection)');
        }
